...
- **services/jsltService.ts** — обёртка над нативным движком Schibsted JSLT (`jslt-node`), который исполняет схему локально и возвращает JSON или сообщение об ошибке.
